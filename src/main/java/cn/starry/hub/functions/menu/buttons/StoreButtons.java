...
public class StoreButtons {
    ...
    public ItemStack getPoint() {
        ...
        item = new ItemBuilder(Material.BOOK).name(ColorUtil.color(" &f充值点券")).lore(lores).build();
    ...
    public ItemStack getRank() {
        ...
        item = new ItemBuilder(Material.EMERALD).name(ColorUtil.color(" &f会员")).lore(lores).build();
        meta = item.getItemMeta();
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack getMysteryBox() {
        ...
        item = new ItemBuilder(Material.ENDER_CHEST).name(ColorUtil.color(" &f神秘箱")).lore(lores).build();
        meta = item.getItemMeta();
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack getHorn() {
        ...
        item = new ItemBuilder(Material.HOPPER).name(ColorUtil.color(" &f喇叭")).lore(lores).build();
        meta = item.getItemMeta();
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack getSuffix() {
        ...
        item = new ItemBuilder(Material.NAME_TAG).name(ColorUtil.color(" &f后缀")).lore(lores).build();
        meta = item.getItemMeta();
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack getBooster() {
        ...
        item = new ItemBuilder(Material.POTION).name(ColorUtil.color(" &f硬币增倍器")).lore(lores).build();
        meta = item.getItemMeta();
        item.setItemMeta(meta);
        return item;
    }
