...
public class RankButtons {
    ...
    public ItemStack VIP(Player player) {
        ...
        item = new ItemBuilder(Material.IRON_INGOT).name(ColorUtil.color("&aVIP 会员")).lore(lores).build();
    ...
    public ItemStack VIPUpgrade(Player player) {
        ...
        item = new ItemBuilder(Material.GOLD_INGOT).name(ColorUtil.color("&f &aVIP&c+ &f会员")).lore(lores).build();
        meta = item.getItemMeta();
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack MVP(Player player) {
        ...
        item = new ItemBuilder(Material.DIAMOND).name(ColorUtil.color("&f &bMVP &f会员")).lore(lores).build();
        meta = item.getItemMeta();
        item.setItemMeta(meta);
        return item;
    }
    ...
    public ItemStack MVPUpgrade(Player player) {
        ...
        item = new ItemBuilder(Material.EMERALD).name(ColorUtil.color("&f &bMVP&c+ &f会员")).lore(lores).build();
        meta = item.getItemMeta();
        item.setItemMeta(meta);
        return item;
    }
