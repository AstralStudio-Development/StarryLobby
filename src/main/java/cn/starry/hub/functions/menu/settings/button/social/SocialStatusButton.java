package cn.starry.hub.functions.menu.settings.button.social;
...
public class SocialStatusButton extends Button {

    public boolean isButton = false;
    public Menu parent;
    public int typeID;

    public SocialStatusButton(boolean isButton, Menu parent, int typeID) {
    ...
    public ItemStack getButtonItem(Player player) {
        ...
        return new ItemBuilder(isButton ? Material.BLAZE_POWDER : (isChoose ? Material.LIME_DYE : Material.GRAY_DYE)).name((isChoose ? "&a" : "&c") + "统计信息查询").lore(lores).build();
    }
