 ...
 */
@Include
public class SoloNPC extends AbstractNPC {
    ...
    public List<String> getNpcDisplayName(Player player) {
        ...
        lines.add("&f点击开始游戏");
        lines.add("&e❖ &b单挑模式 &7[v1.4]");
        //lines.add(PlaceholderAPI.setPlaceholders(player, "&e&l" + "%hub_BwSolo%" + "名玩家正在游玩"));
        return lines;
    }

    @Override
    public Location getNpcSpawnLocation() {
        return new Location(Bukkit.getWorld("world"),-5.5,14.8,23.5,-180,0);
    }
    ...
    public void handlePlayerInteract(Player player) {
        Bukkit.dispatchCommand(player,"bwmenu 单挑");
    }
