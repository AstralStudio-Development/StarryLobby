...
public class PageButton extends Button {
    ...
    public ItemStack getButtonItem(Player player) {
        ItemStack itemStack = new ItemStack(Material.BLACK_CARPET);
        ItemMeta itemMeta = itemStack.getItemMeta();

        if (this.hasNext(player)) {
            itemMeta.setDisplayName(this.mod > 0 ? "Next page" : "Previous page");
        } else {
            itemMeta.setDisplayName((this.mod > 0 ? "Last page" : "First page"));
        }
