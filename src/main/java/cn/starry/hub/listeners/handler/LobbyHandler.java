...
public class LobbyHandler {
        ...
        if (!Objects.equals(StarryLobby.getInstance().getType(), "Login")) {
            if (!VanishUtils.isVanish(player)) {
                ...
                Thread.ofVirtual().start(() -> {
                    String joinMsgSetting = Core.getInstance().getMongoDB().getPlayerData(player.getUniqueId(), "settings_chat_joinmessage");
                    if (joinMsgSetting.equalsIgnoreCase("TRUE")) {
    ...
    public void loadMessages(final Player player) {
        String type = StarryLobby.getInstance().getType();
    ...
    public void loadItem(final Player player) {
        ...
        if (!type.equalsIgnoreCase("Login")) {
            ...
            if (!type.equalsIgnoreCase("Lobby")) {
                if (type.equalsIgnoreCase("Prototype")) {
