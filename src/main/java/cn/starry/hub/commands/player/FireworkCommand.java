...
public class FireworkCommand extends Command {
    ...
    public boolean execute(CommandSender sender, String s, String[] strings) {
        ...
        if (!Objects.equals(StarryLobby.getPlugin(StarryLobby.class).getConfig().getString("type"), "Login")) {
            ...
            player.sendMessage(CC.translate("&c&l咻! &7你发射了一个烟花"));
        } else {
    ...
    private void shootRandomFireWork(Player player) {
        ...
        Firework firework = (Firework) playerLocation.getWorld().spawnEntity(playerLocation, EntityType.FIREWORK_ROCKET);
